...
const DeleteDoctor = () => {
  ...
  return (
    ...
    <div className="flex h-auto gap-2 flex-col flex justify-center items-center  p-2 mt-25">
      <h1 className="font-bold text-xl">Delete Doctor</h1>
      {doctors.map((doctor) => (
        <div key={doctor.id} className="flex w-80 h-30 md:w-3/6 lg:w-2/4 lg:gap-5 border-2 rounded-md gap-2">
